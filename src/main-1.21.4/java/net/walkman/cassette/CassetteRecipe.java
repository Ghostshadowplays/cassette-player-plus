...
public class CassetteRecipe extends CustomRecipe {
    public static final RecipeSerializer<CassetteRecipe> SERIALIZER = new CustomRecipe.Serializer<>(CassetteRecipe::new);
                ...
                if (id != null) {
                            ...
                            if (songId != null) {
                                ...
                                try {
                                    ...
                                    if (songHolder.isPresent()) {
                                        ...
                                        ResourceLocation soundId = song.soundEvent().value().location();
                                        if (soundId != null) {
                    ...
                    if (names.size() < 3) {
                        ...
                        if (data != null) {
                            ...
                            var itemOpt = net.minecraft.core.registries.BuiltInRegistries.ITEM.get(id);
                            if (itemOpt != null && itemOpt.isPresent() && itemOpt.get().value() != net.minecraft.world.item.Items.AIR) {
                                trackName = itemOpt.get().value().getName(new ItemStack(itemOpt.get().value())).getString();
                            } else {
