...
public class CassetteCaseScreen extends AbstractContainerScreen<CassetteCaseMenu> {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTicks, int mouseX, int mouseY) {
        ...
        graphics.blit(RenderType::guiTextured, GUI_TEXTURE, x, y, 0.0f, 0.0f, 176, this.imageHeight, 256, 256);
        ...
        graphics.blit(RenderType::guiTextured, GUI_TEXTURE, x + 179, y + 17, 7.0f, 17.0f, 18, 18, 256, 256); 
    }
